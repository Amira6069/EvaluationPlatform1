          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <div style={styles.inputGroup}>
              ...
              <select 
                ...
                disabled={loading}
              >
                <option value="ORGANIZATION" style={styles.roleOption}>
                  🏢 Organization
                </option>
                <option value="EVALUATOR" style={styles.roleOption}>
                  👨‍⚖️ Evaluator
                </option>
                <option value="ADMIN" style={styles.roleOption}>
                  👑 Administrator
                </option>
              </select>
              <div style={styles.roleInfo}>
                <strong>{selectedRole === 'ORGANIZATION' ? '🏢' : selectedRole === 'EVALUATOR' ? '👨‍⚖️' : '👑'}</strong> {getRoleDescription()}
              </div>
            </div>
